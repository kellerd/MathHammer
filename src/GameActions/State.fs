...
let update msg model : Model * Cmd<Msg> =
    ...
    | GameActionListMsg(msg) -> 
        let (gameActionsList, gameActionsListCmd) =
            GameActionsList.State.update msg model.Actions
        { model with Actions = gameActionsList }, 
        Cmd.map GameActionListMsg gameActionsListCmd
